...
- **Type**: `Object`
- **Description**: An object containing structured display data with the following properties.
...
- **Type**: `Object`
- **Description**: Represents the combined desktop space across all monitors.
...
- **Type**: `Array`
- **Description**: An array of objects describing each connected monitor.
