...
- **Not a desktop application framework**  
  Novadesk is focused solely on building desktop widgets. It is not intended for creating full-scale desktop applications.

- **Not a Windows theme or visual modifier**  
  Novadesk does **not** change the Windows visual style. It cannot modify the taskbar, Start menu, desktop icons, File Explorer, or other built-in Windows UI components.

- **Not a window manager**  
  Novadesk does not manage application windows. It cannot:
  - Maximize or minimize other apps
  - Track open windows
